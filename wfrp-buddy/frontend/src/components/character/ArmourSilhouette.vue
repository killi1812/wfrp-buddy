...
<template>
  <v-card class="pa-4 silhouette-card" elevation="4">
    <div class="text-overline mb-2 amber-lighten-2">Armour Points</div>
    <div class="silhouette-container">
      <!-- Simple SVG human silhouette -->
      <svg viewBox="0 0 100 200" class="silhouette-svg">
        <path d="M50 10 C 60 10, 65 20, 50 35 C 35 20, 40 10, 50 10" fill="#333" /> <!-- Head -->
        <path d="M40 35 L 60 35 L 65 90 L 35 90 Z" fill="#333" /> <!-- Torso -->
        <path d="M35 40 L 15 80 L 25 85 L 40 45 Z" fill="#333" /> <!-- L Arm -->
        <path d="M65 40 L 85 80 L 75 85 L 60 45 Z" fill="#333" /> <!-- R Arm -->
        <path d="M35 90 L 30 180 L 45 180 L 48 90 Z" fill="#333" /> <!-- L Leg -->
        <path d="M65 90 L 70 180 L 55 180 L 52 90 Z" fill="#333" /> <!-- R Leg -->
      </svg>
