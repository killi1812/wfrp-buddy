...
<template>
  <v-card class="pa-2 h-100 grim-card relative-pos" elevation="2">
    ...
    <div class="sin-counter-box d-flex align-center">
      ...
      <v-number-input :model-value="props.sin" @update:model-value="emit('update:sin', $event)" density="compact"
        variant="outlined" hide-details control-variant="stacked" hide-controls class="sin-number-input" />
    </div>
      ...
      <tbody>
        <tr v-for="(p, index) in props.prayers" :key="index">
          ...
          <td class="text-center pa-1">
            <v-text-field v-model="p.Range" hide-details density="compact" variant="plain"
              class="text-center cell-text" />
          </td>
          <td class="text-center pa-1">
            <v-text-field v-model="p.Duration" hide-details density="compact" variant="plain"
              class="text-center cell-text" />
          </td>
          <td class="pa-1">
            <v-text-field v-model="p.Effect" hide-details density="compact" variant="plain"
        ...
        <tr class="new-item-row">
          <td class="pa-1">
            <v-text-field v-model="newItem.Name" placeholder="New Prayer..." hide-details density="compact"
          ...
          <td class="text-center pa-1">
            <v-text-field v-model="newItem.Duration" placeholder="Duration" hide-details density="compact"
